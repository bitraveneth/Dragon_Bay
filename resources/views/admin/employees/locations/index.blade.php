...
<div class="space-y-8">
    ...
    <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
            ...
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        Manual or imported location entries for this employee
                    </p>
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('admin.employees.locations.create', $employee) }}" 
    ...
    @if($logs->isNotEmpty())
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div class="relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition-all hover:shadow-md dark:border-gray-800 dark:bg-gray-900">
                ...
                <div class="relative">
                    <div class="flex items-center justify-between">
                        <span class="text-sm font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">Latest</span>
                    ...
                    <p class="mt-3 text-sm font-medium text-gray-900 dark:text-white truncate">
                        {{ $logs->first()->location_label ?? $logs->first()->notes ?? '—' }}
                    </p>
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        {{ $logs->first()->logged_at?->diffForHumans() }}
                    </p>
                </div>
            </div>
        </div>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        @endif
                                        <a href="{{ route('admin.employees.locations.edit', [$employee, $log]) }}" 
                                           class="inline-flex items-center gap-1 rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-xs font-medium text-gray-700 shadow-sm hover:bg-gray-50 hover:text-brand-600 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-brand-400 transition-colors">
                                            <svg class="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <form action="{{ route('admin.employees.locations.destroy', [$employee, $log]) }}" 
                                              method="POST" 
                                              onsubmit="return confirm('Delete this location log for {{ $log->logged_at?->format('Y-m-d H:i') }}? This action cannot be undone.');"
                                              class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" 
        ...
        <div class="relative overflow-hidden rounded-3xl border border-gray-200 bg-white/50 backdrop-blur-sm p-16 text-center shadow-sm dark:border-gray-800 dark:bg-gray-900/50">
            ...
            <div class="relative">
                ...
                <p class="mt-3 text-base text-gray-500 dark:text-gray-400 max-w-md mx-auto">
                    No location logs have been recorded for {{ $employee->name }} yet. Add your first location log to start tracking.
                </p>
