            ...
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        Select an employee and record a location entry
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="rounded-3xl border border-gray-200 bg-white shadow-xl dark:border-gray-800 dark:bg-gray-900 overflow-hidden">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-0.5">
                        Select employee and enter location information
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="p-8">
            <form action="{{ route('admin.locations.store') }}" method="POST">
                                ...
                                <select id="employee_id" 
                                    ...
                                    @foreach($employees as $employee)
                                        <option value="{{ $employee->id }}" {{ (string)old('employee_id') === (string)$employee->id ? 'selected' : '' }}>
                                            ...
                                            @if($employee->work_zone) · {{ $employee->work_zone }} @endif
                                        </option>
                                    @endforeach
                                </select>
                ...
                @endphp
                @include('admin.employees.locations.partials.form', ['log' => $log, 'employee' => $dummyEmployee])
            ...
            <div>
                ...
                <ul class="mt-2 space-y-1.5 text-sm text-gray-600 dark:text-gray-400">
                    <li class="flex items-start gap-2">
                        ...
                        <span><span class="font-medium">Employee:</span> Select the employee this location belongs to</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="text-brand-500 mt-0.5">•</span>
