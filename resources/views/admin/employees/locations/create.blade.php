...
<div class="max-w-4xl mx-auto space-y-8">
            ...
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        Record a new location entry (e.g. dealer visit, route stop)
                    </p>
    ...
    <div class="rounded-3xl border border-gray-200 bg-white shadow-xl dark:border-gray-800 dark:bg-gray-900 overflow-hidden">
        ...
        <div class="border-b border-gray-100 bg-gradient-to-r from-brand-50 to-white px-8 py-6 dark:border-gray-800 dark:from-brand-950/30 dark:to-gray-900">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">Location Details</h2>
            ...
            <div class="mt-4 flex items-start gap-3 rounded-xl bg-brand-100/50 p-4 text-brand-800 dark:bg-brand-900/30 dark:text-brand-300">
                ...
                <div class="text-sm">
                    ...
                    <span class="ml-1">You can leave coordinates blank and just add a location label or notes.</span>
                </div>
            </div>
        </div>

        <div class="p-8">
            <form action="{{ route('admin.employees.locations.store', $employee) }}" method="POST">
                @csrf
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
        <div class="flex items-start gap-4">
            ...
            <div>
                <h3 class="text-sm font-semibold text-gray-900 dark:text-white">About Location Tracking</h3>
                <ul class="mt-2 space-y-1.5 text-sm text-gray-600 dark:text-gray-400">
                    <li class="flex items-start gap-2">
                        <span class="text-brand-500 mt-0.5">•</span>
                        <span><span class="font-medium">Date & Time:</span> When the location was recorded (defaults to now)</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="text-brand-500 mt-0.5">•</span>
                        <span><span class="font-medium">Location Label:</span> A descriptive name (e.g. "Dhaka Office", "Mirpur Dealer")</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="text-brand-500 mt-0.5">•</span>
                        <span><span class="font-medium">Coordinates:</span> Latitude and longitude (optional, but recommended for mapping)</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="text-brand-500 mt-0.5">•</span>
                        <span><span class="font-medium">Source:</span> How this location was captured (manual, gps, api, import)</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="text-brand-500 mt-0.5">•</span>
                        <span><span class="font-medium">Notes:</span> Additional context about this location or visit</span>
                    </li>
                </ul>
            </div>
        </div>
