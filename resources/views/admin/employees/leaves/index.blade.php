    ...
    @if($leaves->isNotEmpty())
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div class="relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition-all hover:shadow-md dark:border-gray-800 dark:bg-gray-900">
                ...
                <div class="relative">
                    <div class="flex items-center justify-between">
                        <span class="text-sm font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">Rejected</span>
                    ...
                    <p class="mt-3 text-3xl font-bold text-error-600 dark:text-error-400">{{ $rejectedLeaves + $cancelledLeaves }}</p>
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Rejected & cancelled</p>
                </div>
            </div>
        </div>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('admin.employees.leaves.edit', [$employee, $leave]) }}" 
                                        ...
                                        <form action="{{ route('admin.employees.leaves.destroy', [$employee, $leave]) }}" 
                                              method="POST" 
                                              onsubmit="return confirm('Delete this leave request from {{ $leave->start_date?->format('d M Y') }} to {{ $leave->end_date?->format('d M Y') }}? This action cannot be undone.');"
                                              class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" 
        ...
        <div class="relative overflow-hidden rounded-3xl border border-gray-200 bg-white/50 backdrop-blur-sm p-16 text-center shadow-sm dark:border-gray-800 dark:bg-gray-900/50">
            ...
            <div class="relative">
                ...
                <p class="mt-3 text-base text-gray-500 dark:text-gray-400 max-w-md mx-auto">
                    No leave requests have been recorded for {{ $employee->name }} yet. Add your first leave request to start tracking.
                </p>
