...
<div class="max-w-5xl mx-auto space-y-8">
        ...
        <div>
            <div class="flex items-start gap-4">
                ...
                <div class="relative">
                    ...
                    <div class="relative flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-brand-500 to-brand-600 text-3xl font-bold text-white shadow-xl">
                ...
                <div>
                    ...
                    <div class="mt-3 flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                        ...
                        <span>All fields marked with <span class="text-error-500 font-medium">*</span> are required</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="border-b border-gray-100 bg-gradient-to-r from-brand-50 to-white px-8 py-6 dark:border-gray-800 dark:from-brand-950/30 dark:to-gray-900">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-0.5">Fill in the details below to create a new employee record</p>
                </div>
            </div>
            ...
            <div class="mt-4 flex items-start gap-3 rounded-xl bg-brand-100/50 p-4 text-brand-800 dark:bg-brand-900/30 dark:text-brand-300">
                ...
                <p class="text-sm">
                    <span class="font-semibold">Note:</span> After creating the employee profile, you can grant badges, create login accounts, and manage contracts from the employee detail page.
                </p>
            </div>
        </div>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
        <div class="flex items-start gap-4">
            ...
            <div>
                <h3 class="text-sm font-semibold text-gray-900 dark:text-white">Quick Tips for Employee Creation</h3>
                <ul class="mt-2 space-y-1.5 text-sm text-gray-600 dark:text-gray-400">
                    <li class="flex items-start gap-2">
                        <span class="text-brand-500 mt-0.5">•</span>
                        <span>Upload a professional photo for the employee profile</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="text-brand-500 mt-0.5">•</span>
                        <span>Employee ID will be auto-generated if left blank</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="text-brand-500 mt-0.5">•</span>
                        <span>Add multiple tags separated by commas for better filtering</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="text-brand-500 mt-0.5">•</span>
                        <span>You can create login accounts and contracts after saving</span>
                    </li>
                </ul>
            </div>
        </div>
