            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        Record a marketing campaign and its performance metrics.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="rounded-3xl border border-gray-200 bg-white shadow-xl dark:border-gray-800 dark:bg-gray-900 overflow-hidden">
        ...
        <div class="border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white px-8 py-6 dark:border-gray-800 dark:from-gray-900/50 dark:to-gray-900">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">New Campaign</h2>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Fill in the information below to create your marketing campaign</p>
                </div>
            </div>
        </div>
