...
<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                Logistics view of deliveries by route, vehicle and proof of delivery.
            </p>
        </div>
        <div class="flex items-center gap-3">
    ...
    @if($deliveries->isNotEmpty())
        ...
        @php
            ...
            $podUploaded = $deliveries->whereNotNull('pod_photo')->count();
        @endphp
            ...
            <div class="rounded-xl bg-white p-5 border border-gray-200 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-2xl font-semibold text-blue-light-600 dark:text-blue-light-400">{{ $inTransit }}</p>
                    </div>
            ...
            <div class="rounded-xl bg-white p-5 border border-gray-200 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-2xl font-semibold text-success-600 dark:text-success-400">{{ $delivered }}</p>
                    </div>
            ...
            <div class="rounded-xl bg-white p-5 border border-gray-200 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-2xl font-semibold text-gray-900 dark:text-white">{{ $podUploaded }}</p>
                    </div>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white shadow-theme-sm dark:border-gray-800 dark:bg-gray-900 overflow-hidden">
            <div class="border-b border-gray-100 px-6 py-4 dark:border-gray-800">
                <div class="flex items-center justify-between">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white">Logistics Dashboard</h3>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                        @foreach($deliveries as $delivery)
                            @php
                                ...
                                $podStatusIcon = $delivery->pod_photo ? 'check' : 'clock';
                            @endphp
                                        ...
                                        <div class="flex items-center gap-2">
                                            <div class="relative flex-1">
                                                <input type="file" 
                                                       name="pod_photo" 
                                                       accept="image/*"
                                                       class="w-full text-xs file:mr-2 file:rounded-md file:border-0 file:bg-gray-100 file:px-2 file:py-1 file:text-xs file:font-medium file:text-gray-700 hover:file:bg-gray-200 dark:file:bg-gray-700 dark:file:text-gray-300">
                                            </div>
                                            @if($delivery->pod_photo)
                                                <a href="{{ Storage::url($delivery->pod_photo) }}" 
                                                   target="_blank"
                                                   class="inline-flex items-center gap-1 rounded-lg border border-gray-300 bg-white px-2 py-1 text-xs font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-white/[0.03]">
                                                    <svg class="h-3 w-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    @else
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-12 text-center shadow-theme-sm dark:border-gray-800 dark:bg-gray-900">
            ...
            <p class="text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">
                No deliveries have been scheduled yet. Schedule your first delivery to start tracking logistics.
            </p>
            <a href="{{ route('admin.deliveries.create') }}" 
               class="inline-flex items-center gap-2 rounded-lg bg-brand-500 px-4 py-2.5 text-sm font-semibold text-white shadow-theme-sm hover:bg-brand-600 focus:outline-none focus:ring-2 focus:ring-brand-500/50">
                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
