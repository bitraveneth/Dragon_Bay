    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                Record supplier invoices and book AP.
            </p>
        </div>
        ...
        <div class="border-b border-gray-100 px-6 py-4 dark:border-gray-800">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400">Enter supplier and date information</p>
                </div>
            </div>
        </div>

        <form action="{{ route('admin.bills.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="space-y-4">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Default: 30 days from bill date</p>
                        @error('due_date')
                            <p class="mt-1 text-sm text-error-600 dark:text-error-500">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div id="bill-items" class="space-y-4">
                    ...
                    <div class="bill-item-row rounded-xl border border-gray-200 bg-gray-50 p-5 dark:border-gray-700 dark:bg-gray-800/50">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center gap-2">
                                <div class="flex h-8 w-8 items-center justify-center rounded-full bg-brand-100 dark:bg-brand-500/20">
                                    <span class="text-xs font-semibold text-brand-700 dark:text-brand-400">1</span>
                                </div>
                                <div>
                                    <h4 class="text-sm font-medium text-gray-900 dark:text-white">Line Item 1</h4>
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
                            ...
                            <!-- Product (Optional) -->
                            <div>
                                <label for="items[0][product_id]" class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                                    Product (Optional)
                                </label>
                            ...
                            <!-- Quantity -->
                            <div>
                                <label for="items[0][quantity]" class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            <!-- Unit Price -->
                            <div>
                                <label for="items[0][unit_price]" class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
